...
**StealthVision-MCP** adalah platform asisten keamanan yang dirancang khusus untuk mempermudah alur kerja bug bounty hunting dan penetration testing. Dengan protokol MCP, asisten AI Anda dapat mengeksekusi **58 modul uji keamanan** secara dinamis, menyimpan hasilnya ke database SQLite lokal, dan mengekspor laporan profesional dalam format HTML, Markdown, atau CSV.
...
# 6. Jalankan server
python server.py
# Output sukses: [StealthVision] Loaded 58/58 tool modules
```

---

## 🧰 Modules Inventory (58 Modules)
